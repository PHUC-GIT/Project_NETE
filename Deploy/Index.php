...
function regen_section() {
    ...
    'Status' => 'Resource/Side_Icons/Status_Inactive.png', // Status Icons
...
if (isset($_GET['req'])) {
    ...
    switch($section_value) {
        case 'home':
            regen_section();
            $_SESSION['Section_Status']['Status'] = 'active';
            $_SESSION['Section_Status']['Home_Disable'] = 'disabled';
            $_SESSION['Predefined_Icons_State']['Status'] = 'Resource/Side_Icons/Status_Active.png';
            break;
        case 'utility':
            regen_section();
...
// File Array Start >> Use doc.php, file_share.php, reviewreportfile.php, status.php also use for quick access right below! 
...
//This one is for folder inside doc.php
$folder_icons_mime = array(
    'no' => './Resource/FormatIcons/Folder_Standard.png',
    'star' => './Resource/FormatIcons/Folder_Star.png',
    'music' => './Resource/FormatIcons/Folder_Music.png',
    'video' => './Resource/FormatIcons/Folder_Video.png',
    'image' => './Resource/FormatIcons/Folder_Image.png',
    'doc' => './Resource/FormatIcons/Folder_Doc.png',
    'danger' => './Resource/FormatIcons/Folder_Alert.png',
);
...
// File Array End
// Tamper Timer Start >> Use in doc.php, file_share.php, reviewreportfile.php, status.php!
    ...
    <body class="mainscrollgone">
        ...
        <header>
            <div class="Sidebar-Wrapper">
                <!-- Side Bar -->
                <div class="Sidebar">
                    <button title="Status" class="btn pointer SidebarItem Status <?php echo XSS($_SESSION['Section_Status']['Status']);?>" onclick="window.location.href='index.php?req=home';" <?php echo XSS($_SESSION['Section_Status']['Home_Disable']);?>><img src="<?php echo XSS($_SESSION['Predefined_Icons_State']['Status']);?>"></button>
            ...
            <div class="Bottombar">
                <div style="display: flex;">
                    <a class="btn_gems_buttom MAIN_Q" onclick="showModalMenu()"><svg width="30" height="30" version="1.1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g transform="matrix(.027834 .01607 -.01607 .027834 -16.564 -16.584)" stroke-linejoin="round"><g stroke-width="2.8846"><path d="m1156.8 85.482-112.47 194.8 224.93-3e-4zm-3.2624 21.849 95.175 164.85-192.47 1.2248z" style="paint-order:stroke fill markers"/><path d="m1269.3 280.27-224.93-.002 112.47 194.8zm-20.553 8.0994-95.175 164.85-97.297-166.07z" style="paint-order:stroke fill markers"/><path d="m931.87 85.472 112.47 194.8 112.47-194.8zm17.291 13.75h190.35l-95.176 167.3z" style="paint-order:stroke fill markers"/></g><g stroke-width="1.522"><path transform="matrix(1.8952 -8.9302e-8 8.9302e-8 1.8952 87.007 -287.64)" d="m505.11 299.65-59.341 102.78-59.341-102.78z" style="paint-order:stroke fill markers"/><path transform="matrix(.94774 -1.6413 1.6413 .94774 73.81 825.31)" d="m505.11 299.65-59.341 102.78-59.341-102.78z" style="paint-order:stroke fill markers"/><path transform="matrix(.94774 -1.6413 1.6413 .94774 -38.65 630.51)" d="m505.11 299.65-59.341 102.78-59.341-102.78z" style="paint-order:stroke fill markers"/></g></g></svg>NET.E</a>
                    <?php
                    if (isset($_SESSION['AUTHENTICATE_ADMIN'])) {
                    ?>
                ...
                <div style="display: flex;">
                    <a class="info_bottom">Scroll down<svg class="scroll_svg down-arrow" width="24" height="24" version="1.1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path transform="matrix(1.433 0 0 -1.433 3.074 25.241)" d="m3.4375 7.9999 4.655 8.0626h-9.3099z" stroke-linejoin="round" stroke-width="1.522" style="paint-order:stroke fill markers"/></svg><svg class="scroll_svg up-arrow" width="24" height="24" version="1.1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path transform="matrix(1.433 0 0 1.433 3.074 -9.2408)" d="m3.4375 7.9999 4.655 8.0626h-9.3099z" stroke-linejoin="round" stroke-width="1.522" style="paint-order:stroke fill markers"/></svg>Scroll up</a>
                    <a class="info_bottom">|</a>
                    <a class="info_bottom"><svg width="24" height="24" version="1.1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" style="fill: white;"><path d="m7.9635 1.1281c-1.7485-.0045194-3.4791.70159-4.7289 1.9235-1.5237 1.4423-2.3024 3.6125-2.0653 5.6946.17832 1.6507.97436 3.2277 2.2182 4.3316 1.1969 1.1148 2.8137 1.7549 4.4456 1.794.92992.009 1.8652-.13337 2.7274-.49092 2.0336-.79848 3.6137-2.6274 4.1258-4.749.20717-.83061.22366-1.7011.13734-2.5492-.29225-2.2233-1.7407-4.2548-3.7536-5.2459-.95948-.4821-2.0335-.72102-3.1064-.70883zm.038401 1.1109c1.6982-.013627 3.3983.78949 4.4601 2.1093 1.148 1.3822 1.5809 3.3252 1.1244 5.0712-.13931.52189-.35073 1.0547-.63276 1.53-1.0223-.93791-2.1533-1.8162-3.4972-2.2312-.09824-.026712.11863-.087253.15019-.13426.61749-.39822 1.0309-1.0729 1.1636-1.7892.11128-.72416-.051858-1.4936-.50732-2.0755-.54574-.73493-1.4825-1.1516-2.3943-1.0533-1.2846.085126-2.3944 1.2328-2.4347 2.5195-.085773 1.0051.48247 2.0104 1.3571 2.498-1.2073.35819-2.2318 1.1428-3.0989 2.0343-.15911.1591-.318.31844-.47703.47763-1.063-1.5842-1.2753-3.7042-.50606-5.4525.67879-1.6213 2.1466-2.8875 3.8379-3.3153.47129-.12378.96263-.1882 1.455-.18857z" stroke-linecap="round" stroke-width=".063122" style="paint-order:stroke fill markers"/></svg><?php echo XSS($name_login ?? '')?></a>
        ...
        <!-- Message Modal -->
        <div id="modalMessage" onclick="if(event.target === this) closeModalMessage()" style="display:none; position:fixed; z-index:102; left:0; top:0; width:100vw; height:100vh; align-items:center; justify-content:center;">
        ...
        <!-- Welcome Modal -->
        <div id="modalWelcome" onclick="if(event.target === this) closeModalWelcome()" style="display:none; position:fixed; z-index:102; left:0; top:0; width:100vw; height:100vh; align-items:center; justify-content:center;">
            <div style="background-color: rgba(0, 0, 0, 0.5);border: 1px solid gray;color: white;padding:15px 15px;border-radius:10px;min-width:300px;text-align:center;position:relative;font-family: 'Roboto', sans-serif; -webkit-backdrop-filter: blur(15px); backdrop-filter: blur(15px); fill: white;">
                <div style="display: flex; justify-content: right; align-items: center;">
                ...
                <svg width="60" height="60" version="1.1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g transform="matrix(.027834 .01607 -.01607 .027834 -16.564 -16.584)" stroke-linejoin="round"><g stroke-width="2.8846"><path d="m1156.8 85.482-112.47 194.8 224.93-3e-4zm-3.2624 21.849 95.175 164.85-192.47 1.2248z" style="paint-order:stroke fill markers"/><path d="m1269.3 280.27-224.93-.002 112.47 194.8zm-20.553 8.0994-95.175 164.85-97.297-166.07z" style="paint-order:stroke fill markers"/><path d="m931.87 85.472 112.47 194.8 112.47-194.8zm17.291 13.75h190.35l-95.176 167.3z" style="paint-order:stroke fill markers"/></g><g stroke-width="1.522"><path transform="matrix(1.8952 -8.9302e-8 8.9302e-8 1.8952 87.007 -287.64)" d="m505.11 299.65-59.341 102.78-59.341-102.78z" style="paint-order:stroke fill markers"/><path transform="matrix(.94774 -1.6413 1.6413 .94774 73.81 825.31)" d="m505.11 299.65-59.341 102.78-59.341-102.78z" style="paint-order:stroke fill markers"/><path transform="matrix(.94774 -1.6413 1.6413 .94774 -38.65 630.51)" d="m505.11 299.65-59.341 102.78-59.341-102.78z" style="paint-order:stroke fill markers"/></g></g></svg>
                <br><br>
                <span>Welcome, </span><a style="font-family: 'Roboto', sans-serif; font-weight: bold;"><?php echo XSS($name_login ?? '')?>!</a>
                <br><br>
                <span>Current Build: 170.27042026</span>
                <br><br>
                <button class="normal_button" onclick="closeModalWelcome()">Close</button>
            </div>
        </div>
        <!-- Menu Modal -->
         <div id="modalmenu" onclick="if(event.target === this) closeModalMenu()" style="display:none; position:fixed; z-index:102; left:0; top:0; width:100vw; height:100vh; align-items:center; justify-content:center;">
            <div style="background-color: rgba(0, 0, 0, 0.5);border: 1px solid gray;color: white;padding:15px 15px;border-radius:10px;width:500px;height:500px;text-align:center;position:relative;font-family: 'Roboto', sans-serif; -webkit-backdrop-filter: blur(15px); backdrop-filter: blur(15px); fill: white;">
                ...
                <div class="List_Container_Menu">
                    ...
                    <a class="MenuList Status" href="index.php?req=home">
                        <svg style="margin-left: 10px;" width="30" height="30" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g><path d="m4.2137 14.847v12.184h-1.9478v.95404h1.9478v1.3516h.99379v-1.3516h24.527v-.95404h-24.527v-24.368h-.99379v12.184z" style="paint-order:stroke fill markers"/><rect x="7.0224" y="20.013" width="19.788" height="5.6779" ry=".8" style="paint-order:stroke fill markers"/><rect x="7.0224" y="12.651" width="16.359" height="5.6779" ry=".8" style="paint-order:stroke fill markers"/><rect x="7.0224" y="5.2883" width="22.712" height="5.6779" ry=".8" style="paint-order:stroke fill markers"/></g></svg>
                        <span style="margin-left: 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Status</span>
                    </a>
        ...
        <script src="JS/ArrowControl.js" type="text/javascript"></script>
        <script>
