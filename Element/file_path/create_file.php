...
<html lang="en">
    ...
    <div>
        ...
        <div align="center" class="text_container">
            <form name="create_files" id="actionform_PDF" method="post" action="Element/File/fileact.php">
            <input type="hidden" name="reqact" value="createfile"/>
